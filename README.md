...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-loz5xa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-loz5xa.containers.anotherwebservice.com/
...
```
git clone git@github.com:vdtrix34-pixel/container-loz5xa.git
cd container-loz5xa
```
...
```
docker attach container-loz5xa
```
